...
# ※ ロンゾ・ボールは2/2026トレード期限でジャズへ放出→ジャズ側で放出されNBAから離脱
# ※ デアンドレ・ハンターは2/1にキングスへ放出
# ※ タイ・ジェロームは2025夏オフにメンフィス
# ※ トリスタン・トンプソンは引退
CLE_PLAYERS = [
    # スターター（G1 ECF）
    ...
    (32, "ディーン・ウェイド", "PF", 206, 100, "1996-11-20", 6, "カンザス州立大出身。ストレッチ4、G1で29分10点5R3A"),
